...
* Specify the secret name and namespace location in the Verrazzano custom resource.
  ...
  [`spec.components.certManager.certificate.ca`](/docs/reference/api/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.CA) in the Verrazzano custom resource:
...
[`spec.components.certManager.certificate.acme`](/docs/reference/api/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.Acme)
