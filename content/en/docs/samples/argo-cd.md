...
- Enable Argo CD using the instructions at [Enable a component by customizing an installation profile]({{< relref "/docs/setup/install/profiles#enable-a-component-by-customizing-an-installation-profile" >}}).
