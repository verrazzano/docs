...
- New API version for the Verrazzano resource, install.verrazzano.io/v1beta1. See the [Deprecated API Migration Guide]({{< relref "/docs/reference/migration" >}}) for more details.
