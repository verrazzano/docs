...
If you want the logs sent to an external Elasticsearch, specify `elasticsearchURL` and `elasticsearchSecret` in [fluentd]({{< relref "/docs/reference/API/Verrazzano/Verrazzano.md#fluentd-component" >}}) in Verrazzano CRD.
