...
Verrazzano installs a curated set of open source software. The following table lists the software, its version, and a brief description.
  ...
  |--------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------------------------------------------------------------------------------|
  | [Argo CD]({{< relref "/docs/reference/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.ArgoCDComponent" >}})                                 | 2.8.3        | A declarative, GitOps continuous delivery tool for Kubernetes.                           |
  ...
  | [Istio]({{< relref "/docs/reference/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.IstioComponent" >}})                                    | 1.19.0       | Service mesh that layers transparently onto existing distributed applications.           |
  ...
  | [Kiali]({{< relref "/docs/reference/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.KialiComponent" >}})                                    | 1.73.0       | Management console for the Istio service mesh.                                           |
  | [kube-state-metrics]({{< relref "/docs/reference/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.KubeStateMetricsComponent" >}})            | 2.10.0        | Provides metrics about the state of Kubernetes API objects.                              |
  ...
  | [Node Exporter]({{< relref "/docs/reference/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.PrometheusNodeExporterComponent" >}})           | 1.6.1        | Prometheus exporter for hardware and OS metrics.                                         |
  ...
  | [Prometheus Pushgateway]({{< relref "/docs/reference/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.PrometheusPushgatewayComponent" >}})   | 1.6.2        | Allows ephemeral and batch jobs to expose their metrics to Prometheus.                   |
  | [Rancher]({{< relref "/docs/reference/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.RancherComponent" >}})                                | 2.7.6        | Manages multiple Kubernetes clusters.                                                    |
  ...
  | Rancher OCNE Driver         | 0.26.0        |                           |
  | [Thanos]({{< relref "/docs/reference/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.ThanosComponent" >}})                                  | 0.32.2       | Integrates with Prometheus to access and store metrics data.                             |
  ...
  | [WebLogic Kubernetes Operator]({{< relref "/docs/reference/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.WebLogicOperatorComponent" >}})  | 4.1.2        | Assists with deploying and managing WebLogic domains.                                    |
  | [WebLogic Monitoring Exporter]({{< relref "/docs/reference/vpo-verrazzano-v1beta1#install.verrazzano.io/v1beta1.WebLogicOperatorComponent" >}})  | 2.1.5        | Exports Prometheus-compatible metrics from WebLogic instances.                           |
