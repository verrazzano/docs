...
Verrazzano supports the following install profiles:  development (`dev`), production (`prod`), and
managed cluster (`managed-cluster`).  For more information, see [Install Profiles]({{< relref "/docs/setup/install/profiles.md"  >}}).
