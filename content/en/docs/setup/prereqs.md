...
| Velero                       | 1.8.1   | Manages back up and restore of kubernetes configurations and data.                       |
| Rancher Backup Operator      | 2.1.3   | Manages back up and restore of Rancher configurations and data.                          | 