...
You can deploy applications using standard Kubernetes resources, as described in the [Standard Kubernetes Resources]({{< relref "/docs/samples/standard-kubernetes.md" >}})
example.
