...
| `scraper` | string | The Prometheus deployment used to scrape the related metrics endpoints. By default the Verrazzano Prometheus will be used for scraping the endpoint. | No |
