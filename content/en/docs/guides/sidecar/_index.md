...
- Follow the instructions at [Verrazzano Logging]({{< relref "/docs/observability/logging" >}}) to ensure that the [Fluentd DaemonSet]({{< relref "/docs/observability/logging/configure-fluentd#fluentd-daemonset" >}}) collected the logs from stdout.
  These logs will appear in the Verrazzano-managed [OpenSearch]({{< relref "/docs/observability/logging/configure-opensearch.md" >}}) and [OpenSearch Dashboards]({{< relref "/docs/observability/logging/configure-opensearch#opensearch-dashboards" >}}).
