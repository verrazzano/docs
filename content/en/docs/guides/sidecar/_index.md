...
You may want to add additional sidecars to Verrazzano workloads. You may use any image or sidecar container, but this guide will serve as an introduction by showing you how to create a custom Fluentd sidecar for application logs.
